    ...
    <main className="privacy-policy">
      ...
      <div className="content">
        <span className="highlite">
          <b>Last updated February 01, 2021</b>
        </span>
        ...
        <p>
          ...
          <span className="highlite">chimerastudiotm@gmail.com</span>.
        </p>
        ...
        <p>
          ...
          <b>Services</b>&quot;, which include the App), we appreciate that you
        ...
        <p>
          ...
          but not limited to Device IDs. The information that I request will be
        ...
        <p>
          ...
          The information collected is not shared with anyone outside of our
          internal team except in situations where we are obligated to do so by
          law.
        </p>
        ...
        <p>
          Our servers are located in the UK. If you are accessing our App from
        ...
        <p>
          ...
          applications that may be linked to or from the App. You should review
          the policies of such third parties and contact them directly to
        ...
        <p>
          ...
          at <span className="highlite">chimerastudiotm@gmail.com</span>
        </p>
      </div>
    </main>
  );
